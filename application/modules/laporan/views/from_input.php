...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <table class="table">
      <form class="form" action="<?php echo base_url('t_lapor/proses_tambah') ?>" method="post">


<tr>  <td> <b>Nama Kelompok:</b> </td></tr>
<tr>
  <td>
      <input type="text" class="form-control" name="nama_kelompok"  placeholder="Input Nama Kelompok">
  </td>
</tr>
...
<tr>
  ...
  <option value=0>--Pilih Kelompok Dahulu--</option>
    </select>
  </td>
</tr>
...
<tr>
  <td>
      <input type="text" class="form-control" name="nama_ketua"  placeholder="Input Nama Ketua">
  </td>
</tr>
...
<tr>
  <td>
      <input type="number" class="form-control" name="jumlah_anggota"  placeholder="Input Jumlah Anggota">
  </td>
</tr>
...
<tr>
  <td>
      <input type="text" class="form-control" name="sk_pengukuhan"  placeholder="Input SK Pengukuhan">
  </td>
</tr>
...
<tr>
  <td>
      <input type="text" class="form-control" name="sk_kemenkuham"  placeholder="Input SK Kemenkuham">
  </td>
</tr>
...
<tr>
  <td>
      <input type="text" class="form-control" name="no_hp"  placeholder="Input No Hp/ Whatsapp">
  </td>
</tr>
...
<tr>
  <td>
    <input type="date" class="form-control" name="tanggal_input" value="<?php echo $hari; ?>" readonly>
      </td>
</tr>
...
<tr>
  <td>
<textarea name="keterangan" class="form-control" rows="15" placeholder="Masukan Data Keterangan Dan unggah Data tabel ke google drive Paste di halaman ini....."></textarea>
      </td>
</tr>
...
<input type="submit" name="submit" class="btn btn-danger" value="Simpan Data">
