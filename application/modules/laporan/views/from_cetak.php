...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <table class="table">
      <form class="form" action="<?php echo base_url('laporan/proses_cetak') ?>" method="post">
...
<input type="submit" name="submit" class="btn btn-primary" value="Cetak Data">

<a href="<?php echo base_url('laporan') ?>" class="btn btn-info">Batal</a>
